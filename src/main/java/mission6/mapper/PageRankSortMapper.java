...
public class PageRankSortMapper extends Mapper<Object, Text, FloatWritable, Text> {
    private Text page = new Text();
    private FloatWritable pr = new FloatWritable();

    @Override
    protected void map(Object key, Text value, Mapper<Object, Text, FloatWritable, Text>.Context context)
